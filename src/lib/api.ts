...
const PUBLIC_API_MESSAGES = new Set([
  ...
  // Platform administration: suspension and admin guardrails.
  "This account has been suspended by platform administration.",
  "Your workspace has been suspended by platform administration.",
  "You cannot deactivate your own account.",
  "You cannot change your own role.",
  "You cannot suspend your own workspace.",
  "User not found.",
  "Organization not found.",
  "Candidate records cannot be assigned a workspace role. Invite them to a workspace instead.",
  "This user has no workspace. Assign them to a workspace before changing their role.",
  "This user is the only owner of their workspace. Promote another member first.",
