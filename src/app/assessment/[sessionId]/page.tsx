      ...
      <div className="mx-auto grid max-w-[1480px] lg:grid-cols-[250px_minmax(0,1fr)]">
        <aside className="hidden min-h-[calc(100vh-64px)] border-r border-neutral-200 bg-white p-4 lg:block">
          ...
          {interviewer.followUps.length ? (
            <button className={`mt-3 flex w-full items-center gap-3 rounded-[6px] px-3 py-3 text-left text-sm font-bold ${view === "interviewer" ? "bg-violet-600 text-white" : "text-neutral-600 hover:bg-neutral-50"}`} onClick={() => setView("interviewer")} type="button">
